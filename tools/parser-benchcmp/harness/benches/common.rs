    ...
    pub fn bytes(self) -> &'static [u8] {
        match self {
            Self::Constitution1978 => {
                include_bytes!("/state/crates/parser/examples/assets/boe-a-1978-31229-full.xml")
            }
            Self::Consolidated2021 => {
                include_bytes!("/state/crates/parser/examples/assets/boe-a-2021-13171-full.xml")
            }
        }
    }
